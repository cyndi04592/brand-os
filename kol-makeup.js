...
(function () {
  ...
  function contribute(ctx) {
    ...
    return 'makeup: ' + makeupText + ' — a thin surface finish only that must not smooth or replace the real skin underneath, makeup looks naturally worn not freshly applied';
  }
